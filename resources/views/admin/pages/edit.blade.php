	...
	<section class="content container-fluid">
	    <div class="box">
	        <div class="box-header">
	            <h3 class="box-title">Sửa Pages</h3>
	        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" name="name_vn" placeholder="Xin nhập tên tiêu đề" value="{{ $objPages['name_vn'] }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control"  name="description_vn">{{ $objPages['content_vn'] }}</textarea>
                                </div>
                            </div>
