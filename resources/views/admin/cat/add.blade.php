                 ...
                 <div class="row">
                    <div class="col-md-4">
                       <div class="form-group">
                          ...
                          <input class="form-control" type="text" value="" name="name_category" placeholder="Nhập tên danh mục">
                       </div>
                       <div class="form-group">
                          <label>vị trí</label>
                          <input class="form-control" type="number" value="" name="position" placeholder="Nhập vị trí">
                       </div>
                    </div>
