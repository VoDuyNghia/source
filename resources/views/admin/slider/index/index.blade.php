  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Slider Trang chủ</li>
      </ol>
    </section>
    <!-- Main content -->
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th class="text-center">
                      <a href="{{ route('admin.slider.index.add') }}" class="btn btn-sm btn-success">
                ...
                <tbody>
                  @foreach ($objSlider as $value)
                    <tr id="delete-coloum-{{$value->id}}">
                      ...
                      <td class="text-center">
                          <a href="{{ route('admin.slider.index.edit',[$value->id ]) }}" class="btn btn-warning btn-xs edit-category">Sửa</a> || 
    ...
    $('#delete-save').on('click',function(){
        ...
        success:function(data){
            ...
            if(data.success){
                ...
                setTimeout(function(){location.href='{{ route('admin.slider.index.index') }}';},2000);
            }else{
