...
<div class="content-wrapper" style="min-height: 445px;">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Thêm Slider Product</li>
        </ol>
    </section>
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Thêm Slider Product</h3>
        </div>
        <div class="box-header">
           <div class="col-lg-12" style="padding-bottom:50px">
              <form action="{{ route('admin.slider.product.add') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                 <div class="row">
                    <div class="col-md-4">
